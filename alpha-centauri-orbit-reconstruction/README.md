...
Key Results
QuantityValueOrbital period~79.9 yearsEccentricity~0.518Max separation (apoastron ~1980)~21.7 arcsecMin separation (periastron ~1956)~2.1 arcsecNewton–Raphson residual~10⁻¹⁵ (machine precision)
...
How to Run
bashpip install numpy matplotlib scipy jupyter
